...
var ɵ1 = function (f) { return f.endsWith('.js') && !f.endsWith('.d.js'); }, ɵ0 = function (file) { return ({ migration: require("../../migrations/" + file).default, name: path.parse(file).name }); };
exports.ɵ1 = ɵ1;
exports.ɵ0 = ɵ0;
...
function calculateMigrationsToRun(migrations, latestMigration) {
    var startingWith = latestMigration ? migrations.findIndex(function (item) { return item.name === latestMigration; }) + 1 : 0;
